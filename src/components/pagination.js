...
const Pagination = ({ onPageChange, totalCount, siblingCount, currentPage, pageSize }) => {
  ...
  return (
    <ul className={styles.paginationContainer}>
      <li
        onClick={onPrevClick}
        className={`${isFirstPage ? styles.paginationDisable : ''} ${styles.paginationCursor}`}
      >
        Previous
      </li>
      {paginationRange.map((pageNum) => (
        <li
          ...
          className={`${styles.paginationItem} ${
            pageNum === currentPage ? styles.activePaginationItem : ''
          }`}
          key={pageNum}
        >
          {pageNum}
      ...
      <li
        onClick={onNextClick}
        className={`${isLastPage ? styles.paginationDisable : ''} ${styles.paginationCursor}`}
      >
        Next
      </li>
    </ul>
